    ...
    return(
        <div>
            <form className={"flex justify-around w-5/6 m-auto pt-10"}>
                <input className={"w-1/3 rounded-xl pl-3"} type={"text"} placeholder={"введите адрес отправления..."}/>
                <input className={"w-1/3 rounded-xl pl-3"} type={"text"} placeholder={"введите адрес прибытия..."}/>
                <button
